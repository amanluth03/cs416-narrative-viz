...
2. **The Overlap** — beeswarm of all 800 Pokémon's total stats, legendary vs. ordinary, with a threshold line at the weakest legendary's score (580) and a callout: 48 ordinary Pokémon cross it.
3. **Find the Exceptions** — scatter of all 800 Pokémon, Attack vs. Defense, colored by legendary status, spotlighting Slaking (670 total, no legendary status).
